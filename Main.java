...
public class Main
{
    ...
    public static void main(String[] args) throws IOException, ParseException
    {
        ...
        String now = input.replace("", "%20");
        try{
        String goTo = ("http://api.openweathermap.org/data/2.5/weather?q=" + now);
        String goToForecast=("http://api.openweathermap.org/data/2.5/forecast/daily?q="+now);

            WeatherData currentWeather= new WeatherData(goTo);
            ...
            FiveDayForecast currentCityForecast = new FiveDayForecast(goToForecast);
            System.out.println("Tomorrow's average temperature will be: "+currentCityForecast.getTomorrowTemp());
            System.out.println("Tomorrow we will experience " + currentCityForecast.getTomorrowWeatherType());
            System.out.println("Day 2 Temp: "+currentCityForecast.getDayAfterTomorrowTemp());
            System.out.println("Day 2 Forecast: "+currentCityForecast.getDayAfterTomorrowWeatherType());
            System.out.println("Day 3 Temp: " +currentCityForecast.getDayThreeTemp());
            System.out.println("Day 3 Forecast: "+currentCityForecast.getDayThreeWeatherType());
            System.out.println("Day 4 Temp: "+currentCityForecast.getDayFourTemp());
            System.out.println("Day 4 Forecast: "+currentCityForecast.getDayFourWeatherType());
            System.out.println("Day 5 Temp: "+currentCityForecast.getDayFiveTemp());
            System.out.println("Day 5 Forecast: "+currentCityForecast.getDay5WeatherType());



}catch(Exception e)
        {
            System.out.println("Information unavailable for this city at the moment");
        }
